                                                ...
                                                <div class="card shadow-none bg-light border">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="col-12">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Nhập id nhà cung cấp..." name="tensp">
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <textarea class="form-control" placeholder="Nhập mô tả..." rows="4" cols="4"></textarea>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Nhập giá cũ...">
                                                            </div>
                                                            <div class="col-12">
