...
<head>
    <meta charset="utf-8">
    <title>Ăn nhanh 247 - Admin Thêm Sản Phẩm</title>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row g-3">
                                                            <div class="col-12">
                                                                ...
                                                                <input type="number" class="form-control" placeholder="Nhập giá bán..." name="giamoi">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input type="number" class="form-control" placeholder="Nhập giá cũ..." name="giacu">
