        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarEcommerce">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="V_danhsachsanpham.html">Danh
                                        sách sản phẩm</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-products-details.html">Chi
                                        tiết sản phẩm</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-orders.html">Đơn
                                        đặt hàng</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-orders-details.html">Chi
                                        tiết đặt hàng</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-customers.html">Khách
                                        hàng</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-shopping-cart.html">Giỏ
                                        hàng</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-checkout.html">Thanh
                                        toán</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-sellers.html">Người
                                        bán</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarquanly">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="V_themsanpham.html">Thêm sản
                                        phẩm</a>
                                </li>
                                <li>
                                    <a href="V_themnhanvien.html">Thêm khách
                                        hàng</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarEmail">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="apps-email-inbox.html">Hộp thư
                                        đến</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarProjects">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="apps-projects-list.html">Danh
                                        sách</a>
                                </li>
                                <li>
                                    <a href="apps-projects-details.html">Chi
                                        tiết</a>
                                </li>
                                <li>
                                    <a href="apps-projects-gantt.html">Gantt
                                        <span class="badge rounded-pill badge-light-lighten font-10 float-end">Mới</span></a>
                                </li>
                                <li>
                                    <a href="apps-projects-add.html">Tạo dự
                                        án <span class="badge rounded-pill badge-success-lighten font-10 float-end">Mới</span></a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarTasks">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="apps-tasks-details.html">Chi
                                        tiết</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarPages">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="pages-faq.html">Câu hỏi thường
                                        gặp</a>
                                </li>
                                <li>
                                ...
                                <li class="side-nav-item">
                                    ...
                                    <div class="collapse" id="sidebarPagesAuth">
                                        <ul class="side-nav-third-level">
                                            <li>
                                                <a href="pages-login.html">Đăng
                                                    nhập</a>
                                            </li>
                                            <li>
                                                <a href="pages-login-2.html">Login
                                                    2</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="pages-register-2.html">Register
                                                    2</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="pages-logout-2.html">Logout
                                                    2</a>
                                            </li>
                                            <li>
                                                <a href="pages-recoverpw.html">Recover
                                                    Password</a>
                                            </li>
                                            <li>
                                                <a href="pages-recoverpw-2.html">Recover
                                                    Password 2</a>
                                            </li>
                                            <li>
                                                <a href="pages-lock-screen.html">Lock
                                                    Screen</a>
                                            </li>
                                            <li>
                                                <a href="pages-lock-screen-2.html">Lock
                                                    Screen 2</a>
                                            </li>
                                            <li>
                                                <a href="pages-confirm-mail.html">Confirm
                                                    Mail</a>
                                            </li>
                                            <li>
                                                <a href="pages-confirm-mail-2.html">Confirm
                                                    Mail 2</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="side-nav-item">
                                    ...
                                    <div class="collapse" id="sidebarPagesError">
                                        <ul class="side-nav-third-level">
                                            <li>
                                                <a href="pages-404.html">Error
                                                    404</a>
                                            </li>
                                            <li>
                                                <a href="pages-404-alt.html">Error
                                                    404-alt</a>
                                            </li>
                                            <li>
                                                <a href="pages-500.html">Error
                                                    500</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li>
                                    <a href="pages-starter.html">Trang bắt
                                        đầu</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="pages-timeline.html">Mốc thời
                                        gian</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarLayouts">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="layouts-horizontal.html">Nằm
                                        ngang</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-title side-nav-item mt-1">Các thành
                        phần</li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarBaseUI">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="ui-embed-video.html">Embed
                                        Video</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarExtendedUI">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="extended-range-slider.html">Range
                                        Slider</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarForms">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="form-elements.html">Basic
                                        Elements</a>
                                </li>
                                <li>
                                    <a href="form-advanced.html">Form
                                        Advanced</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="form-fileuploads.html">File
                                        Uploads</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarTables">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="tables-datatable.html">Data
                                        Tables</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="help-box text-white text-center">
                    ...
                    <p class="mb-3">Nâng cấp tài khoản để có tất cả các
                        quyền.</p>
                    ...
                    <ul class="list-unstyled topbar-menu float-end mb-0">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="align-middle d-none d-sm-inline-block">Tiếng
                                    anh</span> <i class="mdi mdi-chevron-down d-none d-sm-inline-block align-middle"></i>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg">
                                ...
                                <div style="max-height: 230px;" data-simplebar>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Bạn nhận
                                            được 1 bình luận
                                            <small class="text-muted">1 phút
                                                trước</small>
                                        </p>
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Người dùng
                                            mới đăng ký.
                                            <small class="text-muted">5 giờ
                                                trước</small>
                                        </p>
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Cristina
                                            Pride</p>
                                        <p class="text-muted mb-0 user-msg">
                                            <small>Hi, How are you? What
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Caleb
                                            Flakelar commented on Admin
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Karen
                                            Robinson</p>
                                        <p class="text-muted mb-0 user-msg">
                                            <small>Wow ! this admin looks
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Carlos
                                            Crouch liked
                                            <b>Admin</b>
                                            <small class="text-muted">13
                                                days ago</small>
                                        </p>
                                    </a>
                                </div>
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        ...
                                        <div class="w-100">
                                            <h5 class="m-0 font-14">Erwin
                                                Brown</h5>
                                            <span class="font-12 mb-0">UI
                                                Designer</span>
                                        </div>
                                    </div>
                                </a>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="text-sm-end">
                                                ...
                                                <button type="button" class="btn btn-light mb-2 me-1">Nhập dữ liệu</button>
                                                <button type="button" class="btn btn-light mb-2">Xuất dữ liệu</button>
                                            </div>
                                        </div><!-- end col-->
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data_sanpham as $key => $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?php echo $value['anhsanpham'] ?>" alt="contact-img" title="contact-img" class="rounded me-3" height="48">
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                                <a href="apps-ecommerce-products-details.html" class="text-body"><?php echo $value['tensanpham'] ?></a>
                                                                <br>
        ...
        <div class="rightbar-content h-100" data-simplebar>
            ...
            <div class="p-3">
                ...
                <div class="form-check form-switch mb-1">
                    ...
                    <label class="form-check-label" for="light-mode-check">Chế
                        độ sáng</label>
                </div>

                <div class="form-check form-switch mb-1">
                    <input class="form-check-input" type="checkbox" name="color-scheme-mode" value="dark" id="dark-mode-check">
                    <label class="form-check-label" for="dark-mode-check">Chế
                        độ tối</label>
                </div>
                ...
                <div class="form-check form-switch mb-1">
                    ...
                    <label class="form-check-label" for="fluid-check">Mở
                        rộng</label>
                </div>

                <div class="form-check form-switch mb-1">
                    <input class="form-check-input" type="checkbox" name="width" value="boxed" id="boxed-check">
                    <label class="form-check-label" for="boxed-check">Thu
                        nhỏ</label>
                </div>
                ...
                <div class="form-check form-switch mb-1">
                    ...
                    <label class="form-check-label" for="default-check">Mặc
                        định</label>
                </div>
                ...
                <div class="form-check form-switch mb-1">
                    ...
                    <label class="form-check-label" for="condensed-check">Cô
                        đọng</label>
                </div>

                <div class="form-check form-switch mb-1">
                    <input class="form-check-input" type="checkbox" name="compact" value="scrollable" id="scrollable-check">
                    <label class="form-check-label" for="scrollable-check">Có
                        thể cuộn</label>
                </div>

                <div class="d-grid mt-4">
                    <button class="btn btn-primary" id="resetBtn">Đặt về mặc
                        định</button>
