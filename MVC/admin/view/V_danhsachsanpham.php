...
<head>
    <meta charset="utf-8">
    <title>Ăn nhanh 247 - Admin Danh Sách Sản Phẩm</title>
                                                ...
                                                foreach ($data_sanpham as $key => $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="table-action">
                                                            ...
                                                            <a href="?controller=xulysanpham&method=sua&id=<?php echo $value['id'] ?>" class="action-icon">
                                                                <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="?controller=xulysanpham&method=xoasp&id=<?php echo $value['id'] ?>" class="action-icon">
