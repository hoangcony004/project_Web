                            ...
                            <div class="col-lg-8 mx-auto">
                             <div class="card">
                               <div class="card-header py-3 bg-transparent"> 
                                  <h5 class="mb-0">Thêm đơn hàng</h5>
                                 </div>
                               <div class="card-body">
                                 ...
                                 <form class="row g-3">
                                        ...
                                        <div class="row" data-toggle="buttions">
                                            <div class="col">
                                                <label class="btn btn-outline-decondary">Nam
                                                    <input id="check1" type="radio" name="gioitinh" value="Nam"></span>
                                                </label>
                                            </div>
                                            <div class="col">
                                                <label class="btn btn-outline-decondary">Nữ
                                                    <input id="check2" type="radio" name="gioitinh" value="Nữ"></span>
                                                </label>
                                            </div>
                                        </div>
                                   </div>
                                   <div class="col-12">
                                     ...
                                     <textarea  class="form-control" name="diachi" cols="50" rows="4"  placeholder="Nhập đầy đủ địa chỉ..."></textarea>
                                   </div>
                                   <div class="col-12">
