                                    ...
                                    <div class="border p-3 rounded">
                                        <form class="row g-3" action="?controller=themdonhang" method="post">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <!-- <input type="text" class="form-control" placeholder="Nhập địa chỉ chi tiết..." name="quanhuyen"> -->
                                                <textarea name="diachichitiet" id="" placeholder="Nhập địa chỉ chi tiết..." cols="50" rows="3"></textarea>
                                            </div>
                                            <div class="col-12">
