                ...
                <div class="row">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="?controller=giohang"><i
                            ...
                            <li>
                                <form action="#" method="post">
                                    <input type="search"
                                        ...
                                        name="tim_kiem"
                                        style=" border: 1px solid; border-radius: 5px; margin-top: 20px;">
                                    <button
                                        style="padding: 2px 15px; border: 1px solid; border-radius: 5px; background-color: cornflowerblue;
                ...
                <ul class="product-tab"
                    ...
                    <li role="presentation"
                        class="active"><a
                            ...
                            aria-controls="home"
                            role="tab"
                            data-toggle="tab">Pizza</a></li>
                    <li role="presentation"><a
                            href="#profile"
                            aria-controls="profile"
                            role="tab"
                            data-toggle="tab">Sườn BBQ</a></li>
                    <li role="presentation"><a
                            href="#ttchitiet"
                            aria-controls="ttchitiet"
                            role="tab"
                            data-toggle="tab">Mì Ý</a></li>
                    <li role="presentation"><a
                            href="#danhgia"
                            aria-controls="ttchitiet"
                            role="tab"
                            data-toggle="tab">Salad</a></li>
                    <li role="presentation"><a
                            href="#dagiao"
                            aria-controls="ttchitiet"
                            role="tab"
                            data-toggle="tab">Đồ uống</a></li>
                    <li role="presentation"><a
                            href="#khac"
                            aria-controls="ttchitiet"
                            role="tab"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-sm-6">
                                                        <div class="single-shop-product">
                                                            ...
                                                            <h2><a href="single-product.html">Macbook M2 2023</a></h2>
                                                            <div class="product-carousel-price">
                                                                <ins>$899.00</ins> <del>$999.00</del>
                                                            </div>
