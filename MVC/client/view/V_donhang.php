    ...
    <div class="single-product-area">
        ...
        <div role="tabpanel">
            <ul class="product-tab" role="tablist">
                <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Chờ xác nhận</a></li>
                <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Chờ lấy hàng</a></li>
                <li role="presentation"><a href="#danhgia" aria-controls="ttchitiet" role="tab" data-toggle="tab">Đang giao hàng</a></li>
                <li role="presentation"><a href="#dagiao" aria-controls="ttchitiet" role="tab" data-toggle="tab">Đã giao hàng</a></li>
            </ul>
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" style="text-align: center;">
                    <h2>Chờ Xác Nhận</h2>
