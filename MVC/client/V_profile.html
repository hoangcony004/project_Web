                                ...
                                <form action="#" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text"
                                                    placeholder="Nhập địa chỉ(Nhập tỉnh)..."
                                                    name="diachi">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <button class="btn btn-primary"
                                                    type="submit" name="btn_capnhat">Cập
                                                    nhật</button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-menu">
                            ...
                            <ul>
                                <li><a style="text-decoration: none;"
                                        href="V_profile.html">Tài khoản của tôi</a></li>
        ...
        <div class="footer-bottom-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <div class="copyright">
                            <p>Bản quyền của <a style="text-decoration: none;"
                                    href="https://www.facebook.com/profile.php?id=100020891342691">hoàng</a>
